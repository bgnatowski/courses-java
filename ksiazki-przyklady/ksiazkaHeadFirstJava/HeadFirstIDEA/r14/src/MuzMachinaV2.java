...
public class MuzMachinaV2 {
	...
	public void tworzGUI() {
		...
		JButton wyczyscB = new JButton("Wyczyść plansze");
		wyczyscB.addActionListener(new WyczyscListener());
		obszarPrzyciskow.add(wyczyscB);
