// Zmiana rozmiarów obiektów graficznych, aby pasowały do bieżących wymiarów okna
import java.awt.*;
...
public class ResizeMe extends Frame {
  ...
  public ResizeMe() {
    // Anonimowa klasa wewnętrzna do obsługi zdarzeń MouseRelease
    ...
    // Anonimowa klasa wewnętrzna do obsługi zdarzeń zamknięcia okna
